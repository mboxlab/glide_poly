...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Rear left
		self:CreateWheel(Vector(-54.987800598145, 34.650501251221, 23),
		                 {model = "models/simpoly/wheels/porsche_911_carrera_rsr.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-54.987800598145, -34.650501251221, 23),
		                 {model = "models/simpoly/wheels/porsche_911_carrera_rsr.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
