...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-100, -25, 15)}, {pos = Vector(-100, 25, 15)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Rear left
		self:CreateWheel(Vector(-58.811000823975, 36.306198120117, 23),
		                 {model = "models/simpoly/wheels/ferrari_599_gto.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-58.811000823975, -36.306198120117, 23),
		                 {model = "models/simpoly/wheels/ferrari_599_gto.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
