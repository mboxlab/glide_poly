...
ENT.ChassisModel = "models/simpoly/porsche_911_gt2.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-100, -25, 12)}, {pos = Vector(-100, 25, 12)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(51.412300109863, 31.73810005188, 23), {
