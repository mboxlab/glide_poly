...
ENT.Author = "kekobka"
ENT.PrintName = "Dodge Charger 1969"

ENT.GlideCategory = "Poly - Muscle"
ENT.ChassisModel = "models/simpoly/charger1969.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-105, -22, 17)}, {pos = Vector(-105, 22, 17)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(-35, -17.5, 14), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
		self:CreateWheel(Vector(60.07559967041, 32.740200042725, 22), {
			model = "models/simpoly/wheels/charger1969.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-60.057201385498, 32.740200042725, 22),
		                 {model = "models/simpoly/wheels/charger1969.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-60.057201385498, -32.740200042725, 22),
		                 {model = "models/simpoly/wheels/charger1969.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})

		self:ChangeWheelRadius(14.6)
	end
end
