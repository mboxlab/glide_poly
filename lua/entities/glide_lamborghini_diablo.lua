...
ENT.Author = "kekobka"
ENT.PrintName = "Lamborghini Diablo"

ENT.GlideCategory = "Poly - Sport"
ENT.ChassisModel = "models/simpoly/lamborghini_diablo.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-100, -15, 16)}, {pos = Vector(-100, 15, 16)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(61.806400299072, 37.747898101807, 22), {
			model = "models/simpoly/wheels/lamborghini_diablo.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-61.806400299072, 39.747898101807, 23),
		                 {model = "models/simpoly/wheels/lamborghini_diablo.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1.02, 0.5, 1.02)})

		-- Rear right
		self:CreateWheel(Vector(-61.806400299072, -39.747898101807, 23),
		                 {model = "models/simpoly/wheels/lamborghini_diablo.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1.02, 0.5, 1.02)})
