...
ENT.Author = "kekobka"
ENT.PrintName = "Lamborghini Urus"

ENT.GlideCategory = "Poly - Suv"
ENT.ChassisModel = "models/simpoly/lamborghini_urus.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(-30, 19.5, 23), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
		self:CreateWheel(Vector(64.487396240234, 37.261901855469, 23), {
			model = "models/simpoly/wheels/lamborghini_urus.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-64.487396240234, 38.261901855469, 23),
		                 {model = "models/simpoly/wheels/lamborghini_urus.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-64.487396240234, -38.261901855469, 23),
		                 {model = "models/simpoly/wheels/lamborghini_urus.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})

		self:ChangeWheelRadius(18.2)
	end
end
