...
ENT.Author = "kekobka"
ENT.PrintName = "Land Rover Range Rover Sport"

ENT.GlideCategory = "Poly - Suv"
ENT.ChassisModel = "models/simpoly/land_rover_range_rover_sport.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(62.426998138428, 36.225299835205, 23), {
			model = "models/simpoly/wheels/land_rover_range_rover_sport.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-62.426998138428, 36.225299835205, 23),
		                 {model = "models/simpoly/wheels/land_rover_range_rover_sport.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-62.426998138428, -36.225299835205, 23),
		                 {model = "models/simpoly/wheels/land_rover_range_rover_sport.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
