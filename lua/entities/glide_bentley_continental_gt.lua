...
ENT.Author = "kekobka"
ENT.PrintName = "Bentley Continental GT"

ENT.GlideCategory = "Poly - Sedan"
ENT.ChassisModel = "models/simpoly/bentley_continental_gt.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-105, -28, 16)}, {pos = Vector(-105, 28, 16)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(-35, -17.5, 12), Angle(0, 270, 18), Vector(0, -80, 0), true)
		self:CreateSeat(Vector(-35, 17.5, 12), Angle(0, 270, 18), Vector(0, -80, 0), true)
		self:CreateSeat(Vector(-35, 0, 12), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
		self:CreateWheel(Vector(60.305198669434, 35.81729888916, 23), {
			model = "models/simpoly/wheels/bentley_continental_gt.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-60.305198669434, 35.81729888916, 23),
		                 {model = "models/simpoly/wheels/bentley_continental_gt.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-60.305198669434, -35.81729888916, 23),
		                 {model = "models/simpoly/wheels/bentley_continental_gt.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
