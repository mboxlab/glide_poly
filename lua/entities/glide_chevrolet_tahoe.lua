...
ENT.Author = "kekobka"
ENT.PrintName = "Chevrolet Tahoe"

ENT.GlideCategory = "Poly - Suv"
ENT.ChassisModel = "models/simpoly/chevrolet_tahoe.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(-20, -19.5, 23), Angle(0, 270, 18), Vector(0, -80, 0), true)
		self:CreateSeat(Vector(-20, 19.5, 23), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
		self:CreateWheel(Vector(60.24100112915, 34.093299865723, 23), {
			model = "models/simpoly/wheels/chevrolet_tahoe.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-56.24100112915, 34.093299865723, 23),
		                 {model = "models/simpoly/wheels/chevrolet_tahoe.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-56.24100112915, -34.093299865723, 23),
		                 {model = "models/simpoly/wheels/chevrolet_tahoe.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
