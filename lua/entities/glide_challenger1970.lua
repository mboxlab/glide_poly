...
ENT.Author = "kekobka"
ENT.PrintName = "Dodge Challenger 1970"

ENT.GlideCategory = "Poly - Muscle"
ENT.ChassisModel = "models/simpoly/challenger1970.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {
		{pos = Vector(-105, -18, 19)},
		{pos = Vector(-105, 18, 19)},
		{pos = Vector(-105, -14, 19)},
		{pos = Vector(-105, 14, 19)},
		--
	}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(62.009498596191, 32.009399414063, 20), {
			model = "models/simpoly/wheels/challenger1970.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-60.926601409912, 32.009399414063, 20),
		                 {model = "models/simpoly/wheels/challenger1970.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-60.926601409912, -32.009399414063, 20),
		                 {model = "models/simpoly/wheels/challenger1970.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})

		self:ChangeWheelRadius(14.3)
	end
end
