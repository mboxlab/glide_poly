...
ENT.Author = "kekobka"
ENT.PrintName = "BMW E30"

ENT.GlideCategory = "Poly - Sedan"
ENT.ChassisModel = "models/simpoly/bmw_e30.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {
		{pos = Vector(-107, 22, 12)},
		{pos = Vector(-107, 18, 12)},
		--
	}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(-40, 15.5, 15), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
		self:CreateWheel(Vector(60.747299194336, 34.087200164795, 23),
		                 {model = "models/simpoly/wheels/bmw_e30.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Front right
		self:CreateWheel(Vector(60.747299194336, -34.087200164795, 23),
		                 {model = "models/simpoly/wheels/bmw_e30.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Rear left
		self:CreateWheel(Vector(-60.747299194336, 34.087200164795, 23),
		                 {model = "models/simpoly/wheels/bmw_e30.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-60.747299194336, -34.087200164795, 23),
		                 {model = "models/simpoly/wheels/bmw_e30.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})
