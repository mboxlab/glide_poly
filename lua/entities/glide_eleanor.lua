...
ENT.Author = "kekobka"
ENT.PrintName = "Shelby GT500 Eleanor 1967"

ENT.GlideCategory = "Poly - Muscle"
ENT.ChassisModel = "models/simpoly/eleanor.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(-35, -17.5, 14), Angle(0, 270, 18), Vector(0, -80, 0), true)
		self:CreateSeat(Vector(-35, 17.5, 14), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
		self:CreateWheel(Vector(61.440498352051, 33.432201385498, 23),
		                 {model = "models/simpoly/wheels/eleanor.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Front right
		self:CreateWheel(Vector(61.440498352051, -33.432201385498, 23),
		                 {model = "models/simpoly/wheels/eleanor.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Rear left
		self:CreateWheel(Vector(-61.430999755859, 33.432201385498, 23),
		                 {model = "models/simpoly/wheels/eleanor.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-61.430999755859, -33.432201385498, 23),
		                 {model = "models/simpoly/wheels/eleanor.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})

		self:ChangeWheelRadius(13.7)
	end
end
