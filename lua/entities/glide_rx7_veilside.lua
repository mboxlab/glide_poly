...
ENT.Author = "kekobka"
ENT.PrintName = "Mazda RX-7 Veilside"

ENT.GlideCategory = "Poly - Sedan"
ENT.ChassisModel = "models/simpoly/rx7_veilside.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-105, -25, 16)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(-12, -17.5, 13), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
		self:CreateWheel(Vector(57.377601623535, 35.752998352051, 23), {
			model = "models/simpoly/wheels/rx7_veilside.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-57.338600158691, 38.598999023438, 23),
		                 {model = "models/simpoly/wheels/rx7_veilside.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-57.338600158691, -38.598999023438, 23),
		                 {model = "models/simpoly/wheels/rx7_veilside.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
