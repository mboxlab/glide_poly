...
ENT.Author = "kekobka"
ENT.PrintName = "Lamborghini Murcielago"

ENT.GlideCategory = "Poly - Sport"
ENT.ChassisModel = "models/simpoly/lamborghini_murcielago.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-100, 0, 20)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(59.423000335693, 38.757099151611, 23), {
			model = "models/simpoly/wheels/lamborghini_murcielago.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-59.423000335693, 41.757099151611, 23),
		                 {model = "models/simpoly/wheels/lamborghini_murcielago.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-59.423000335693, -41.757099151611, 23),
		                 {model = "models/simpoly/wheels/lamborghini_murcielago.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
