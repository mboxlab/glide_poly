...
ENT.ChassisModel = "models/simpoly/mercedes_benz_a45_amg.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(-30, -17.5, 18), Angle(0, 270, 18), Vector(0, -80, 0), true)
		self:CreateSeat(Vector(-30, 17.5, 18), Angle(0, 270, 18), Vector(0, -80, 0), true)
		self:CreateSeat(Vector(-30, 0, 18), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
