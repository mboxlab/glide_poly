...
ENT.Author = "kekobka"
ENT.PrintName = "Lamborghini Centenario"

ENT.GlideCategory = "Poly - Sport"
ENT.ChassisModel = "models/simpoly/lamborghini_centenario.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-100, 0, 14)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(60.67610168457, 39.938999176025, 23), {
			model = "models/simpoly/wheels/lamborghini_centenario.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-60.67610168457, 39.938999176025, 23),
		                 {model = "models/simpoly/wheels/lamborghini_centenario.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1.02, 0.5, 1.02)})

		-- Rear right
		self:CreateWheel(Vector(-60.67610168457, -39.938999176025, 23),
		                 {model = "models/simpoly/wheels/lamborghini_centenario.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1.02, 0.5, 1.02)})
