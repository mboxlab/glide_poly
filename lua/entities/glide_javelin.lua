...
ENT.Author = "kekobka"
ENT.PrintName = "AMC Javelin"

ENT.GlideCategory = "Poly - Muscle"
ENT.ChassisModel = "models/simpoly/javelin.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {
		{pos = Vector(-38, 40, 10), ang = Angle(0, -80, 0)},
		{pos = Vector(-45, 40, 10), ang = Angle(0, -80, 0)},
		{pos = Vector(-38, -40, 10), ang = Angle(0, 80, 0)},
		{pos = Vector(-45, -40, 10), ang = Angle(0, 80, 0)},
		--
	}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(66.187698364258, 33.58570098877, 20),
		                 {model = "models/simpoly/wheels/javelin.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Front right
		self:CreateWheel(Vector(66.187698364258, -33.58570098877, 20),
		                 {model = "models/simpoly/wheels/javelin.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Rear left
		self:CreateWheel(Vector(-66.278396606445, 33.58570098877, 20),
		                 {model = "models/simpoly/wheels/javelin.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-66.278396606445, -33.58570098877, 20),
		                 {model = "models/simpoly/wheels/javelin.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
