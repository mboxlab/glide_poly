...
ENT.Author = "kekobka"
ENT.PrintName = "Pontiac Firebird 1972"

ENT.GlideCategory = "Poly - Muscle"
ENT.ChassisModel = "models/simpoly/firebird1972.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(62.568599700928, 35.965698242188, 23), {
			model = "models/simpoly/wheels/firebird1972.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-62.569400787354, 35.965698242188, 23),
		                 {model = "models/simpoly/wheels/firebird1972.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-62.569400787354, -35.965698242188, 23),
		                 {model = "models/simpoly/wheels/firebird1972.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
