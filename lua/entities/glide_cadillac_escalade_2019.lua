...
ENT.Author = "kekobka"
ENT.PrintName = "Cadillac Escalade 2019"

ENT.GlideCategory = "Poly - Suv"
ENT.ChassisModel = "models/simpoly/cadillac_escalade_2019.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(10, -19.5, 23), Angle(0, 270, 18), Vector(0, -80, 0), true)
		...
		-- Front left
		self:CreateWheel(Vector(57.414199829102, 33.84529876709, 23), {
			model = "models/simpoly/wheels/cadillac_escalade_2019.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-57.414199829102, 33.84529876709, 23),
		                 {model = "models/simpoly/wheels/cadillac_escalade_2019.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-57.414199829102, -33.84529876709, 23),
		                 {model = "models/simpoly/wheels/cadillac_escalade_2019.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
