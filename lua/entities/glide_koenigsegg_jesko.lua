...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateWheel(Vector(-62.861698150635, 39.424598693848, 23),
		                 {model = "models/simpoly/wheels/koenigsegg_jesko.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-62.861698150635, -39.424598693848, 23),
		                 {model = "models/simpoly/wheels/koenigsegg_jesko.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
