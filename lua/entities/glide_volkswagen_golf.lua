...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Rear left
		self:CreateWheel(Vector(-61.982799530029, 35.191898345947, 23),
		                 {model = "models/simpoly/wheels/volkswagen_golf.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-61.982799530029, -35.191898345947, 23),
		                 {model = "models/simpoly/wheels/volkswagen_golf.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
