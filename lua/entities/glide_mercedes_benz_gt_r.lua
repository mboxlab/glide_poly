...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-105, -24, 15)}, {pos = Vector(-105, 24, 15)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Rear left
		self:CreateWheel(Vector(-61.454498291016, 39.770500183105, 23),
		                 {model = "models/simpoly/wheels/mercedes_benz_gt_r.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-61.454498291016, -39.770500183105, 23),
		                 {model = "models/simpoly/wheels/mercedes_benz_gt_r.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
