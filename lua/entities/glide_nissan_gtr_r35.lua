...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateWheel(Vector(-60.159801483154, 39.028499603271, 23),
		                 {model = "models/simpoly/wheels/nissan_gtr_r35.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-60.159801483154, -39.028499603271, 23),
		                 {model = "models/simpoly/wheels/nissan_gtr_r35.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
