...
ENT.ChassisModel = "models/simpoly/viper.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(59.75350189209, 37.615398406982, 23),
		                 {model = "models/simpoly/wheels/viper.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Front right
		self:CreateWheel(Vector(59.75350189209, -37.615398406982, 23),
		                 {model = "models/simpoly/wheels/viper.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Rear left
		self:CreateWheel(Vector(-59.737998962402, 37.615398406982, 23),
		                 {model = "models/simpoly/wheels/viper.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-59.737998962402, -37.615398406982, 23),
		                 {model = "models/simpoly/wheels/viper.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
