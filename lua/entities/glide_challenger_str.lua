...
ENT.Author = "kekobka"
ENT.PrintName = "Dodge Challenger SRT"

ENT.GlideCategory = "Poly - Muscle"
ENT.ChassisModel = "models/simpoly/challenger_str.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {{pos = Vector(-105, -22, 15)}, {pos = Vector(-105, 22, 15)}}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(-35, 17.5, 14), Angle(0, 270, 18), Vector(0, -80, 0), true)
		self:CreateSeat(Vector(-35, 0, 14), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
		self:CreateWheel(Vector(63.786098480225, 33.111099243164, 23), {
			model = "models/simpoly/wheels/challenger_str.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-63.773998260498, 33.111099243164, 23),
		                 {model = "models/simpoly/wheels/challenger_str.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-63.773998260498, -33.111099243164, 23),
		                 {model = "models/simpoly/wheels/challenger_str.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
