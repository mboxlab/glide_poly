...
ENT.Author = "kekobka"
ENT.PrintName = "Chevrolet Camaro 1976"

ENT.GlideCategory = "Poly - Muscle"
ENT.ChassisModel = "models/simpoly/camaro1976.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(60.229000091553, 33.740398406982, 23),
		                 {model = "models/simpoly/wheels/camaro1976.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Front right
		self:CreateWheel(Vector(60.229000091553, -33.740398406982, 23), {
			model = "models/simpoly/wheels/camaro1976.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-55.219501495361, 33.451698303223, 23),
		                 {model = "models/simpoly/wheels/camaro1976.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-55.219501495361, -33.451698303223, 23),
		                 {model = "models/simpoly/wheels/camaro1976.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
