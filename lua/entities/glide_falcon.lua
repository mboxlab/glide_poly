...
ENT.Author = "kekobka"
ENT.PrintName = "Ford Falcon"

ENT.GlideCategory = "Poly - Muscle"
ENT.ChassisModel = "models/simpoly/falcon.mdl"
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		-- Front left
		self:CreateWheel(Vector(59.970901489258, 31.435300827026, 20),
		                 {model = "models/simpoly/wheels/falcon.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Front right
		self:CreateWheel(Vector(59.970901489258, -31.435300827026, 20),
		                 {model = "models/simpoly/wheels/falcon.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Rear left
		self:CreateWheel(Vector(-54.969299316406, 31.435300827026, 22),
		                 {model = "models/simpoly/wheels/falcon.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-54.969299316406, -31.435300827026, 22),
		                 {model = "models/simpoly/wheels/falcon.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
