...
ENT.Author = "kekobka"
ENT.PrintName = "Ferrari 308 GTO"

ENT.GlideCategory = "Poly - Sport"
ENT.ChassisModel = "models/simpoly/ferrari_308_gto.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {
		{pos = Vector(-100, -19, 15)},
		{pos = Vector(-100, -15, 15)},
		{pos = Vector(-100, 19, 15)},
		{pos = Vector(-100, 15, 15)},
		--
	}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:CreateSeat(Vector(Vector(-15, 17, 18)), Angle(0, 270, 2), Vector(0, 80, 0), true)
		self:CreateSeat(Vector(-2, -17.5, 18), Angle(0, 270, 18), Vector(0, -80, 0), true)
		-- Front left
		self:CreateWheel(Vector(60.280498504639, 39.715599060059, 23), {
			model = "models/simpoly/wheels/ferrari_308_gto.mdl",
		...
		-- Rear left
		self:CreateWheel(Vector(-60.280498504639, 39.715599060059, 23),
		                 {model = "models/simpoly/wheels/ferrari_308_gto.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-60.280498504639, -39.715599060059, 23),
		                 {model = "models/simpoly/wheels/ferrari_308_gto.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
