...
ENT.Author = "kekobka"
ENT.PrintName = "Mercedes-Benz S63"

ENT.GlideCategory = "Poly - Sedan"
ENT.ChassisModel = "models/simpoly/benz_s63.mdl"
...
if CLIENT then
	...
	ENT.ExhaustOffsets = {
		{pos = Vector(-108, 20, 14.5)},
		{pos = Vector(-107, 25, 14.5)},
		{pos = Vector(-108, -20, 14.5)},
		{pos = Vector(-107, -25, 14.5)},
		--
	}
...
if SERVER then
	...
	function ENT:CreateFeatures()
		...
		self:SetPowerDistribution(-0.92)
		self:SetMinRPM(750)
		self:SetMaxRPM(6500)
		...
		-- Front left
		self:CreateWheel(Vector(64.771499633789, 35.261798858643, 23),
		                 {model = "models/simpoly/wheels/benz_s63.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Front right
		self:CreateWheel(Vector(64.771499633789, -35.261798858643, 23),
		                 {model = "models/simpoly/wheels/benz_s63.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1), steerMultiplier = 1})

		-- Rear left
		self:CreateWheel(Vector(-64.77970123291, 35.261798858643, 23),
		                 {model = "models/simpoly/wheels/benz_s63.mdl", modelAngle = Angle(0, 0, 0), modelScale = Vector(1, 0.4, 1)})

		-- Rear right
		self:CreateWheel(Vector(-64.77970123291, -35.261798858643, 23),
		                 {model = "models/simpoly/wheels/benz_s63.mdl", modelAngle = Angle(0, 180, 0), modelScale = Vector(1, 0.4, 1)})
